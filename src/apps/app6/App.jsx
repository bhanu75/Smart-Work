...
export default function App() {
  ...
  const activityCategories = [
    { name: 'Calling Client', color: 'orange', emoji: '📞', icon: 'bg-orange-300' },
    { name: 'Meeting Client', color: 'blue', emoji: '🤝', icon: 'bg-blue-300' },
    { name: 'Exercise', color: 'red', emoji: '💪', icon: 'bg-red-300' },
    { name: 'Trading', color: 'green', emoji: '📈', icon: 'bg-green-300' },
    { name: 'Learning', color: 'purple', emoji: '📚', icon: 'bg-purple-300' },
    { name: 'Planning', color: 'yellow', emoji: '📋', icon: 'bg-yellow-300' },
    { name: 'Reading', color: 'indigo', emoji: '📖', icon: 'bg-indigo-300' },
    { name: 'Personal', color: 'pink', emoji: '🏠', icon: 'bg-pink-300' }
  ];
...
function ActivityCard({ event, onToggle, onEdit, onDelete }) {
  const categoryConfig = {
    'Calling Client': { bg: 'bg-orange-100', badge: 'bg-orange-200', icon: 'bg-orange-300', emoji: '📞', border: 'border-orange-400' },
    'Meeting Client': { bg: 'bg-blue-100', badge: 'bg-blue-200', icon: 'bg-blue-300', emoji: '🤝', border: 'border-blue-400' },
    'Exercise': { bg: 'bg-red-100', badge: 'bg-red-200', icon: 'bg-red-300', emoji: '💪', border: 'border-red-400' },
    'Trading': { bg: 'bg-green-100', badge: 'bg-green-200', icon: 'bg-green-300', emoji: '📈', border: 'border-green-400' },
    'Learning': { bg: 'bg-purple-100', badge: 'bg-purple-200', icon: 'bg-purple-300', emoji: '📚', border: 'border-purple-400' },
    'Planning': { bg: 'bg-yellow-100', badge: 'bg-yellow-200', icon: 'bg-yellow-300', emoji: '📋', border: 'border-yellow-400' },
    'Reading': { bg: 'bg-indigo-100', badge: 'bg-indigo-200', icon: 'bg-indigo-300', emoji: '📖', border: 'border-indigo-400' },
    'Personal': { bg: 'bg-pink-100', badge: 'bg-pink-200', icon: 'bg-pink-300', emoji: '🏠', border: 'border-pink-400' }
  };
