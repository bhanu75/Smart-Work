...
export default function App() { const [shopName, setShopName] = useState("नागरिया बिल्ड सॉल्यूशंस"); const [address, setAddress] = useState("रिको मेन रोड, निंबाहेङा, चित्तौड़गढ़, राजस्थान"); const [mobile, setMobile] = useState("9784485555"); const [billNo, setBillNo] = useState("l72"); const [date, setDate] = useState(""); const [customer, setCustomer] = useState("");
